...
loan_avg = loan_total/loan_amount
print(loan_avg)
...
def value_calculator(value, months, rate):
    final_value = value / (1 + rate/12) ** months
    return(final_value)
...
present_value = value_calculator(new_loan.get("future_value"), 0.2,  new_loan.get("remaining_months"))
